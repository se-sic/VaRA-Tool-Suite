...
class VProject(Project):  # type: ignore
    ...
    This class extends the benchbuild Project class with VaRA-TS specific
    functionality, such as support for test suites and project domains.
    """
    ...
    def __init_subclass__(cls, *args, **kwargs) -> None:  # type: ignore
        ...
        This method is called when a subclass of VProject is created. It ensures
        that the subclass has the necessary methods for supporting test suites,
        and wraps them with the appropriate decorators to run in the build
        directory.
        (See also the implementation of the benchbuild Project class.)
        """
    ...
    @property
    def binaries(self) -> list['ProjectBinaryWrapper']:
    ...
    def binaries_for_revision(
        ...
        Returns a revision specific list of binaries generated
        by the project. This method is abstract and must be
