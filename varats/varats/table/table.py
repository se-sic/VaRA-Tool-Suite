...
class Table:
    ...
    def __init_subclass__(
        cls, *, table_name: str | None, **kwargs: tp.Any
    ) -> None:
    ...
    @staticmethod
    def get_class_for_table_type(table_type: str) -> type['Table']:
        """
    ...
    def table_file_name(self, table_format: TableFormat) -> str:
        ...
        sep_stages = ''
        if self.supports_stage_separation() and self.table_kwargs.get(
            'sep_stages', None
        ):
            sep_stages = 'S'
