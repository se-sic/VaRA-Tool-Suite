...
def create_artefact(
    artefact_type_name: str, name: str, output_path: Path, **kwargs: tp.Any
) -> Artefact:
    """
    ...
    Args:
        ...
        **kwargs: additional arguments used to create the artefact
    ...
    return artefact_type.create_artefact(name, output_path, **kwargs)
    ...
    for raw_artefact in raw_artefacts.pop('artefacts'):
        ...
        try:
            artefact = create_artefact(
                artefact_type_name, name, output_path, **raw_artefact
            )
