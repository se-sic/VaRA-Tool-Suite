...
class PrepareSZZUnleashedData(actions.MultiStep):  # type: ignore
    """
...
class RunSZZUnleashed(actions.MultiStep):  # type: ignore
...
class CreateSZZUnleashedReport(actions.MultiStep):  # type: ignore
