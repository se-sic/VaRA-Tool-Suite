...
class ArchitectureTaintAnalysis(actions.ProjectStep):  # type: ignore
...
class ArchitectureReportExperiment(VersionExperiment, shorthand="ARE"):
    ...
    REPORT_SPEC = ReportSpecification(ArchitectureTaintReport)
    ...
    def actions_for_project(
        ...
        analysis_actions.append(
            ArchitectureTaintAnalysis(project, self.get_handle())
        )
