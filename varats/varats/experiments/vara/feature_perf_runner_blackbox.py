...
from varats.experiments.vara.feature_experiment_blackbox import (
    FeatureExperiment,
    RunVaRAWorkloadsBlackbox,
)
...
class FeaturePerfRunner(FeatureExperiment, shorthand="FPW"):
    """Test runner for feature performance."""

    NAME = "RunFeaturePerfBlackbox"
    ...
    def actions_for_project(
        ...
        analysis_actions.append(
            RunVaRAWorkloadsBlackbox(project, self.get_handle())
        )
