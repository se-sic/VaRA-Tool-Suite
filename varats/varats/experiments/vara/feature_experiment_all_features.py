                            ...
                            with cleanup(prj_command):
                                ...
                                if prj_command.command.label == "FCF":
                                    ...
                                    for elements in feature_permutationen:
                                        ...
                                        for feature in elements:
                                            name_file += feature
                                        if name_file != "trace_FCF":
                                            rename_file = mv[tmp_dir / Path("trace_FCF.json"), tmp_dir / Path(f"{name_file}.json")]
                                            rename_file()
                                        else:
                                            rename_file = mv[tmp_dir / Path("trace_FCF.json"), tmp_dir / Path(f"{name_file}_base.json")]
                                            rename_file()
                                if prj_command.command.label == "CF":
                                    ...
                                    for elements in feature_permutationen:
                                        ...
                                        for feature in elements:
                                            name_file += feature
                                        if name_file != "trace_CF":
                                            rename_file = mv[tmp_dir / Path("trace_CF.json"), tmp_dir / Path(f"{name_file}.json")]
                                            rename_file()
                                        else:
                                            rename_file = mv[tmp_dir / Path("trace_CF.json"), tmp_dir / Path(f"{name_file}_base.json")]
                                            rename_file()
