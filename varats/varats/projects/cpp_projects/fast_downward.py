...
from varats.project.project_util import (
    ...
    verify_binaries, get_local_project_git_path, BinaryType, get_tagged_commits,
)
from varats.project.varats_project import VProject
from varats.provider.release.release_provider import ReleaseProviderHook, ReleaseType
from varats.utils.git_util import ShortCommitHash, RevisionBinaryMap, FullCommitHash
...
class FastDownward(VProject, ReleaseProviderHook):
    ...
    def get_release_revisions(
        ...
        with local.cwd(repo_loc):
            ...
            release_commits = {
                (FullCommitHash('e4eb64c613ae34b97ab9409deac5331ec2ce5e43'), 'release-16.07.0'),
                (FullCommitHash('91f44fa59ea57014a7769062a92aa752f503128e'), 'release-17.01.0'),
                (FullCommitHash('363e2fc9a8b7adb48b4c30e929097798928c7370'), 'release-17.07.0'),
                (FullCommitHash('0e8acd2f2613e032040dc6b6d4bf1926848aa4cb'), 'release-18.01.0'),
                (FullCommitHash('dd7ddfeea72a699d381dce35657d683259be77c0'), 'release-18.07.0'),
                (FullCommitHash('2cc2a66e8073a73571e0a37cd806380f13751a7c'), 'release-19.01.0')
            }
