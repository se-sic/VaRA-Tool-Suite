...
class Libvpx(VProject):
    ...
    def compile(self) -> None:
        ...
        with local.cwd(libvpx_source), local.env(CC=str(clang), CXX=str(cxx)):
    ...
    def prepare_test_environment(self) -> None:
        ...
        clang = bb.compiler.cc(self)
        cxx = bb.compiler.cxx(self)
        with local.cwd(test_source), local.env(CC=str(clang), CXX=str(cxx)):
            ...
            # See if we want to include perf tests as workloads?
