...
class TestFilterTreeElements(unittest.TestCase):
    ...
    def test_author_date_min_filter(self):
        ...
        self.assertEqual(filter_node.resource(),
                         ":/breeze/light/appointment-new.svg")
